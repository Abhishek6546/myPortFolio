...
function Home() {
  ...
  <div name="Home" className='max-w-screen-2xl container mx-auto px-4 md:px-20 my-20'>
    ...
    <br />
     <p className='text-sm md:text-md text-justify'>I am a dedicated web developer with a strong foundation in web development and programming. I enjoy solving complex problems and continuously improving my coding skills. My goal is to leverage my knowledge in HTML, CSS, JavaScript, and ReactJS to contribute to innovative projects and grow as a developer.
             ...
             <div className='space-y-2'>
                ...
                <li><a href="https://www.linkedin.com/in/abhishek-kumar-83bb9a245/" target='_blank'><FaLinkedin className='text-2xl cursor-pointer'/></a></li>
                <li><a href="https://www.facebook.com/profile.php?id=100053752970797" target='_blank'><FaSquareFacebook className='text-2xl cursor-pointer'/></a></li>
                <li><a href="https://github.com/Abhishek6546" target='_blank'><SiGithub className='text-2xl cursor-pointer'/></a></li>
   ...
   <img src="/myphoto.jpg" className='rounded-full  md:w-[450px] md:h-[450px] shadow-lg  brightness-125' alt="myphoto" />
   </div>
   </div>
  </div>
  <hr />
